<div class="row hidden-md hidden-lg">
	<div class="col-md-12">
		<div class="card-desk">
			<h4 style="margin-bottom: 0px;">&nbsp;&nbsp;<i class="glyphicon glyphicon-list"></i> DRINKS MENU</h4>
			<ul class="menu_sp">
				<?php 
		foreach($category_drink as $rows)
		{
		 ?>
				<li><a style="padding-left: 10px;display: block;" href="do-uong/<?php echo remove_unicode($rows->category_name)?>-<?php echo $rows->id_category;?>"><i class="glyphicon glyphicon-adjust"></i> <?php echo $rows->category_name;?></a></li>
		<?php } ?>
			</ul>
		</div>
	</div>
