<div class="row hidden-md hidden-lg">
	<div class="col-md-12">
		...
		{
		 ?>
				<li><a style="padding-left: 10px;display: block;" href="mon-an/<?php echo remove_unicode($rows->category_name)?>-<?php echo $rows->id_category;?>"><i class="glyphicon glyphicon-adjust"></i> <?php echo $rows->category_name;?></a></li>
		<?php } ?>
			</ul>
		</div>
	</div>
