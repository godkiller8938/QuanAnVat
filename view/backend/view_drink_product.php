<div style="margin:15px 0px">
	<div class="row">
		...
		<a href="admin.php?controller=add_edit_product&name=1&act=add" class="btn btn-primary">Thêm sản phẩm</a>
	</div>
	<?php } ?>
	<div class="col-md-6" style="padding-top: 10px">
	...
	<div class="bg-primary text-white" style="padding: 10px;font-size: 17px">Danh sách đồ uống</div>
		...
		<table class="table table-hover table-bordered">
		 ...
		 ?>
			<tr>
				...
				<td style="text-align: center;">
				<?php if($security->id_security==1){ ?>
				<a href="admin.php?controller=add_edit_product&name=1&act=edit&id=<?php echo $rows->id_product; ?>">Sửa</a>&nbsp;&nbsp;
				<a onclick="return window.confirm('Bạn muốn xóa?');" href="admin.php?controller=product&name=1&act=delete&id=<?php echo $rows->id_product; ?>">Xóa</a>
				<?php } ?>
				</td>
			</tr>
		...
		<div class="card-footer" style="padding:7px !important">
        	...
        	<a class="page-link" href="admin.php?controller=product&name=1&p=<?php if($p>1) echo $p=$p-1; else echo $p; ?>">&laquo;</a></li>
		<?php $p=isset($_GET["p"])?$_GET["p"]:1;settype($p,'int'); ?>
        <li class="active page-item"><a class="page-link"><?php if($p>0&&$p<=$num_page) echo $p; else echo "1"; ?></a></li>
     	<?php $p=isset($_GET["p"])?$_GET["p"]:1;settype($p,'int'); ?>
        <li class="page-item"><a class="page-link" href="admin.php?controller=product&name=1&p=<?php if($p<$num_page) echo $p=$p+1; else echo $p; ?>">&raquo;</a></li>
        <li class="page-item"><a class="page-link">Tổng</a></li>
        <li class="page-item"><a class="page-link" href="admin.php?controller=product&name=1&p=<?php echo $num_page; ?>"><?php echo $num_page; ?></a></li>	
			</ul>
		</div>
